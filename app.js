...
var budgetController = (function () {
    ...
    Expense.prototype.calcPercentage = function (totalIncome) {
        if (totalIncome > 0) {
            this.percentage = Math.round((this.value / totalIncome) * 100); // total Income
        } else {
            this.percentage = -1;
        }
    };
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            // exemple  => expense = 100 et income 200, spent 50% = 100/200 = 0.5 *100;
...
var UIController = (function () {
    ...
    return {
        ...
        clearFields: function () {
            ...
            // transforme une liste en tableau exemple : list(1, 2, 3); // [1, 2, 3]
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function () {
        ...
        // 3. Update the UI with the nex percentages
